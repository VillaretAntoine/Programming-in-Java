...
public record Movie_nul(int rank, double rating, String title, int year, String rated, int runtime,
     ...
     * Factory method
     */
    public static Movie_nul of(String rawLine) {
