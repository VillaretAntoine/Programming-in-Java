...
import agh.ii.prinjava.lab07.model.Movie_nul;
...
public class Main {
    ...
    private static void demo1() {
        System.out.println("\ndemo1...");
        final Optional<List<Movie_nul>> movies = ImdbTop250.movies();
        ...
        final double[] top10Ratings = movies.orElseThrow().stream()
                .limit(10)
                .mapToDouble(Movie_nul::rating) // Stream -> DoubleStream
                .toArray();
        ...
        final int[] top10Years = movies.orElseThrow().stream()
                .limit(10)
                .mapToInt(Movie_nul::year) // Stream -> IntStream
                .toArray();
    ...
    private static void demo2() {
        System.out.println("\ndemo2...");
        final Optional<List<Movie_nul>> optMovies = ImdbTop250.movies();
    ...
    private static void demo4() {
        ...
        for (int i = 0; i < theLongestMovies.length; i++) {
            Movie_nul m = (Movie_nul) theLongestMovies[i];
